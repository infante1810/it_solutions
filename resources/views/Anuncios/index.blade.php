...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title">Registros Area 1</h4>
    </div>
    <div class="page-rightheader ml-md-auto">
        <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
            <div class="btn-list">
                <a href="{{route('registro1.create')}}" class="btn btn-primary mr-3">
            ...
            <!--COPIAR DESDE AQUI-->
            <div class="btn-list">
                <a href="{{route('registro1.generatePDF')}}" class="btn btn-primary mr-3">
                    ...
                    <table class="table table-vcenter text-wrap table-bordered border-bottom dt" id="tabla">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>{{$anuncio->total_cost}}</span>
                                </td>
                                <td>
                                    <div class="d-flex">
                                        <a href="{{route('registro1.show',$anuncio->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Ver"><i class="fa-solid fa-eye text-primary"></i></a>
                                        <a href="{{route('registro1.edit',$anuncio->id)}}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa-solid fa-pen text-success"></i></a>
