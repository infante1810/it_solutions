...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        ...
        <ul class="breadcrumb">
            <li class="mb-1 fs-16"><a href="{{ route('departamentos.index') }}">Registro1</a></li>
	...
	<div class="col-xl-12 col-md-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<h4 class="mb-5 font-weight-semibold">Edita el registro {{$departamento->id}} </h4>
				<div class="row">
					<div class="col-md-3">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input id="total_cost" class="form-control @error('total_cost') is-invalid @enderror" type="number" step="0.01"
                                   placeholder="50.00" name="total_cost" required min="0" value="{{ $departamento->total_cost }}">
                            @error('total_cost')
                                <span class="invalid-feedback" role="alert">
                                    <strong> {{ $message }}</strong>
                                </span>
